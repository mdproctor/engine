...
@Component
public class CaseContextChangedSpringAdapter {

  private final CaseContextChangedEventHandler core;

  public CaseContextChangedSpringAdapter(CaseContextChangedEventHandler core) {
    this.core = core;
  }
