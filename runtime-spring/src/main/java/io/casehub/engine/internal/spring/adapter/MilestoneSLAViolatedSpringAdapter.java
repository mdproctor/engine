...
@Component
public class MilestoneSLAViolatedSpringAdapter {

  private final MilestoneSLAViolatedEventHandler core;

  public MilestoneSLAViolatedSpringAdapter(MilestoneSLAViolatedEventHandler core) {
    this.core = core;
  }
