...
@Component
public class JudgmentEscalationSpringAdapter {

  private final JudgmentEscalationHandler core;

  public JudgmentEscalationSpringAdapter(JudgmentEscalationHandler core) {
    this.core = core;
  }
