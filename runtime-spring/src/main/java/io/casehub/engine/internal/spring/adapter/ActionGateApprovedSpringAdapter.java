...
@Component
public class ActionGateApprovedSpringAdapter {

  private final ActionGateApprovedHandler core;

  public ActionGateApprovedSpringAdapter(ActionGateApprovedHandler core) {
    this.core = core;
  }
