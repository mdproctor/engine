...
@Component
public class WorkerScheduleSpringAdapter {

  private final WorkerScheduleEventHandler core;

  public WorkerScheduleSpringAdapter(WorkerScheduleEventHandler core) {
    this.core = core;
  }
