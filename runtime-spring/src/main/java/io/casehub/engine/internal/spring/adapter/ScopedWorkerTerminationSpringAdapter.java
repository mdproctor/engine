...
@Component
public class ScopedWorkerTerminationSpringAdapter {

  private final ScopedWorkerTerminationHandler core;

  public ScopedWorkerTerminationSpringAdapter(ScopedWorkerTerminationHandler core) {
    this.core = core;
  }
