...
@Component
public class MilestoneCompletedSpringAdapter {

  private final MilestoneCompletedEventHandler core;

  public MilestoneCompletedSpringAdapter(MilestoneCompletedEventHandler core) {
    this.core = core;
  }
