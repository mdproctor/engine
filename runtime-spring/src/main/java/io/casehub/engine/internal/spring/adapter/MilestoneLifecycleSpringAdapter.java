...
@Component
public class MilestoneLifecycleSpringAdapter {

  private final MilestoneLifecycleManager core;

  public MilestoneLifecycleSpringAdapter(MilestoneLifecycleManager core) {
    this.core = core;
  }
