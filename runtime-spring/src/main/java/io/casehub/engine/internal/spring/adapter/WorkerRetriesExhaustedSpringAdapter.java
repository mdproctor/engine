...
@Component
public class WorkerRetriesExhaustedSpringAdapter {

  private final WorkerRetriesExhaustedEventHandler core;

  public WorkerRetriesExhaustedSpringAdapter(WorkerRetriesExhaustedEventHandler core) {
    this.core = core;
  }
