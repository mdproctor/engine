 ...
 * io.casehub.engine.planning.subcase.SubCaseCompletionService} after a child case terminates and
 * the parent case has been resumed (or was not waiting). Consumed by {@link
 * io.casehub.engine.planning.handler.PlanItemCompletionHandler} to mark the SubCase PlanItem
 * COMPLETED and trigger stage autocomplete.
 *
