 ...
 * @param stage the stage that was activated
 * @param instanceIndex the instance index at activation time
 */
public record StageActivatedEvent(UUID caseId, String tenancyId, Stage stage, int instanceIndex) {}
