...
import io.casehub.engine.planning.event.StageCompletedEvent;
...
class StageAutocompleteEvaluatorTest {
  ...
  void all_completed_triggers_autocomplete() {
    ...
    verify(eventBus)
        .publish(
            io.casehub.engine.planning.event.BlackboardEventBusAddresses.STAGE_COMPLETED,
  ...
  void repeatable_stage_resets_to_pending_after_autocomplete() {
    ...
    assertThat(stage.getStatus())
        ...
        .isEqualTo(io.casehub.engine.planning.stage.StageStatus.PENDING);
