 ...
 * capability it targeted, the worker that executed, the outcome (SUCCESS/FAILURE/DECLINED), and the
 * priority at which it was selected.
 *
 ...
 *     bindings)
 * @param stepOutcome the worker's outcome (SUCCESS, FAILURE, DECLINED, etc.)
