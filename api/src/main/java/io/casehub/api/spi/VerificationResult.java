...
public sealed interface VerificationResult
  ...
  record InsufficientEvidence(String feedback, List<String> missingRequirements)
  ...
  record TrustTooLow(double required, double actual) implements VerificationResult {}
