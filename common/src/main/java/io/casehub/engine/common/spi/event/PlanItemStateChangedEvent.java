...
/**
 * CDI event fired when a PlanItem transitions between states. Generalises the former {@code
 * PlanItemCompletedEvent}, {@code PlanItemFaultedEvent}, and {@code PlanItemRejectedEvent} into a
 * single event carrying both the previous and new status.
 *
