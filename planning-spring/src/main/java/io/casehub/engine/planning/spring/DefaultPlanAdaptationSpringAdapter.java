...
@Component
public class DefaultPlanAdaptationSpringAdapter {

  private final DefaultPlanAdaptationEvaluator core;

  public DefaultPlanAdaptationSpringAdapter(DefaultPlanAdaptationEvaluator core) {
    this.core = core;
  }

  @EventListener
  public void handle(CompoundCompletedEvent event) {
    core.onCompoundCompleted(event);
  }
}
