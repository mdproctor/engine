...
@Component
public class PlanItemEscalationSpringAdapter {

  private final PlanItemEscalationHandler core;

  public PlanItemEscalationSpringAdapter(PlanItemEscalationHandler core) {
    this.core = core;
  }

  @EventListener
  public void handle(AgentRoutingEscalationEvent event) {
    core.onEscalation(event);
  }
}
