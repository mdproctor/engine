...
/** Auto-selected in-memory {@link SubCaseGroupRepository} for {@code @QuarkusTest}. */
@Alternative
@Priority(1)
@ApplicationScoped
public class TestSubCaseGroupRepository extends InMemorySubCaseGroupRepository {}
