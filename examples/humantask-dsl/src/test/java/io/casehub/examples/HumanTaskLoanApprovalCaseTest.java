...
class HumanTaskLoanApprovalCaseTest {

  @Test
  void definesHumanTaskCase() {
    CaseDefinition def = HumanTaskLoanApprovalCase.define();

    assertEquals("finance", def.getNamespace());
    assertEquals("loan-approval", def.getName());
