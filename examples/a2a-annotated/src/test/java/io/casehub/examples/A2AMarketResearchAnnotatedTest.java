...
class A2AMarketResearchAnnotatedTest {

  @RegisterExtension
  static final QuarkusUnitTest test =
      new QuarkusUnitTest()
          .withApplicationRoot(root -> root.addClasses(A2AMarketResearchAnnotated.class));

  @Inject CaseDefinition definition;

  @Test
  void definesA2ACase() {
    assertThat(definition.getNamespace()).isEqualTo("intelligence");
    assertThat(definition.getName()).isEqualTo("MarketResearch");
