...
class McpCodeAnalysisAnnotatedTest {

  @RegisterExtension
  static final QuarkusUnitTest test =
      new QuarkusUnitTest()
          .withApplicationRoot(root -> root.addClasses(McpCodeAnalysisAnnotated.class));

  @Inject CaseDefinition definition;

  @Test
  void definesMcpCase() {
    assertThat(definition.getNamespace()).isEqualTo("devops");
    assertThat(definition.getName()).isEqualTo("CodeAnalysis");
