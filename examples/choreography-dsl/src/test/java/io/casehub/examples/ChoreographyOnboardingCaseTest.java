...
class ChoreographyOnboardingCaseTest {

  @Test
  void definesChoreographyCase() {
    CaseDefinition def = ChoreographyOnboardingCase.define();

    assertEquals("banking", def.getNamespace());
    assertEquals("customer-onboarding", def.getName());
